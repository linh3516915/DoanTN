...
class APINhapHangController extends Controller
{
    public function nhaphang(Request $rq){
        $sanpham= SanPham::Where('ten',$rq->ten_san_pham)->first();
       ...
       if(empty($sanpham)){
        ...
        $ctsp->ten = $rq->ten_san_pham . ' ' . $tendungluong->kich_thuoc . ' ' . $tenmau->ten_mau_sac;
        ...
        $nhaphang->ten_san_pham = $rq->ten_san_pham . ' ' . $tendungluong->kich_thuoc . ' ' . $tenmau->ten_mau_sac;
        ...
        .$rq->ten_san_pham . ' ' . $tendungluong->kich_thuoc . ' ' . $tenmau->ten_mau_sac.' với số lượng và giá là '
