    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post(`http://127.0.0.1:8000/api/tenshop/capnhat-tenshop/${id}`, {
                ...
                alert('Cập nhật tên shop thành công')
                navigate('/');
                ...
                <div className="row">
                    ...
                    <main className="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                        <div className="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                            <h1 className="h2">CẬP NHẬT TÊN SHOP </h1>
                            ...
                            <div className="col-12">
                                <div className="add_sp-ctsp">
                                    <div className="add_sp">
                                        <div className="row">
                                            <div class="col-md-12">
                                                <label for="Ten" className="form-label ">Tên shop</label>
                                                <input type="text" value={tenshop} onChange={(e) => { setTenShop(e.target.value) }} required />
                                            </div>
                                        </div>
