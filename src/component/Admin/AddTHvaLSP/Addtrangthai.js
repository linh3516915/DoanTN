...
export default function PopupAddtrangthai({ isOpen, onRequestClose,onthemmoincc }) {
    ...
    return (
        ...
        >
            ...
            <form onSubmit={handleSubmit}>
                ...
                <button type="button" className='btn btn-danger' onClick={onRequestClose}>Thoát</button>
                </div>
            </form>
        </Modal>
    );
